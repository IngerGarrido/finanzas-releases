...
// En producción el modo debug queda forzado a OFF aunque el .env diga true:
// nunca se filtran detalles internos (rutas, SQL) al usuario final.
define('APP_DEBUG',  getenv('APP_DEBUG') === 'true' && APP_ENV !== 'production');
...
function requireAuth(): array {
    ...
    $db   = getDB();
    // En la BD se guarda hash('sha256', token); comparamos contra el hash.
